...
// 
        ...
        // controlsGui.add( controls.target, 'x', -2 , 2, 0.04  ).name( 'target.x');
        // controlsGui.add( controls.target, 'y', -2 , 2, 0.04  ).name( 'target.y');
        // controlsGui.add( controls.target, 'z', -2 , 2, 0.04  ).name( 'target.z');
